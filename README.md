...
| 5    | Feb 7        | Formal Relational Query Languages | This lecture will introduce the basics of relational algebra, extended relational algebra, and their connection to data frames and SQL.  |**Homework 4 - release:** Relational Algebra |[Slides](https://drive.google.com/file/d/1m-dxrdhZZWTHXZ1KeDDUYKso1IgnMLAt/view) | | | Understanding Formal Relational languages, such as relational algebra, is crucial for understanding how relational database systems operate. |
